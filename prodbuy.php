<?php
include("db.php");
$pagename="Smart buy for a smart home";                           //Create and populate a variable called $pagename
...
while ($arrayp=mysqli_fetch_array($exeSQL))
{
    ...
    echo "</td>";
    echo "<td style='border: 0px'>";
    echo "<p><h3 class='updateInfo'>".$arrayp['prodName']."</h3></p>"; //display product name as contained in the array
    echo "<p class='updateInfo'>".$arrayp['prodDescripLong']."</p>";
    echo "<p class='updateInfo'><b>&pound".$arrayp['prodPrice']."</b></p>";
    echo "<p class='updateInfo'>Left in Stock: ".$arrayp['prodQuantity']."</p>";
    
    
    echo "<br><p class='updateInfo'>Number to be purchased: </p>";
